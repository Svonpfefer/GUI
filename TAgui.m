...
% Last Modified by GUIDE v2.5 05-Jul-2013 02:22:24
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.ticker = lower(get(hObject, 'String'));
fail = 0;
...
Nsims = 1000;
[simulatedelliots, CI] = bootsclosegui(handles.current_data, Nsims,handles.k);
...
if CI(2) > Ellis
    ...
    myHandle = findobj('Tag','text_sig');
    set(myHandle,'String',null)
...
function text_sig_Callback(hObject, eventdata, handles)
% hObject    handle to text_sig (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of text_sig as text
%        str2double(get(hObject,'String')) returns contents of text_sig as a double




% --- Executes during object creation, after setting all properties.
function text_sig_CreateFcn(hObject, eventdata, handles)
% hObject    handle to text_sig (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
